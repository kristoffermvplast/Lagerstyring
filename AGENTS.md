...
- Implement only the phase explicitly authorized by the user. Phase 14 (material differences and measured waste) is authorized. Do not implement Phase 15 or later workflows.
