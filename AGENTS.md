...
- Implement only the phase explicitly authorized by the user. Phase 17 (stock reservations and release) is authorized. Do not implement Phase 18 or later workflows.
