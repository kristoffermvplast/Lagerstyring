...
- Implement only the phase explicitly authorized by the user. Phase 12 (production registration without inventory delivery or consumption) is authorized. Do not implement Phase 13 or later workflows.
