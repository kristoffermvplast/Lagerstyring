...
- Implement only the phase explicitly authorized by the user. Phase 13 (material return and production closure) is authorized. Do not implement Phase 14 or later workflows.
