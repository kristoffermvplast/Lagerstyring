...
- Implement only the phase explicitly authorized by the user. Phase 5 (versioned BOM and packing definitions) is authorized. Do not implement Phase 6 locations or later workflows.
