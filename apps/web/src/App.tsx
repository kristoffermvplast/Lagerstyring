...
function Administration({company,canManage}:{company:string;canManage:boolean}) {
  ...
  const actionLabels:Record<string,string>={'production.issue':'Sende materiale til produktion','production.record':'Registrere gode emner','production.correct':'Modregistrere gode emner','production.return':'Returnere materiale','production.close':'Afstemme og afslutte produktion'};
