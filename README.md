...
[Etape 1 — navigation og fælles formularprincipper](docs/ux-stage-1.md) er implementeret og målrettet testet lokalt fra `70336e0`. Backend og datamodel er uændrede. Etape 2 er ikke startet; publicering er ikke udført.
