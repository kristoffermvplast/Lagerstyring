...
Se [fasebeskrivelse](phase-26.md) og [drifts-/gendannelsesplan](operations.md). Arbejdsgren fra `ec84bd5`: tværgående HTTP-forløb, adgangsgrænser, afgrænset lokal belastning og separat native PostgreSQL-gendannelse. Lokal integration består; native CI og faktisk hosted backup/restore afventer. Ingen migration eller applikationsændringer. Foto forbliver deaktiveret hosted. Ingen automatisk UI/UX-runde; slutstatus gennemgås først.
