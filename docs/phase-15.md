...
Status: implementation on `phase15-finished-goods`, from verified main `2ef92c1`. Verification in progress; no hosted migration or main deployment yet. Photos remain disabled hosted. Phase 16 is not started.
