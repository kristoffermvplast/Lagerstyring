...
- TLS er aktiv på PostgreSQL-sessionen, og klienten kræver gyldigt certifikat.
...
Supabase-forbindelsen kan først erklæres verificeret, når denne kommando er gennemført mod projektet. Opgaven er fortsat i Fase 1; Fase 2 er ikke autoriseret.
